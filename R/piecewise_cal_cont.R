#' Model-based analysis for continuous data using discontinuous piecewise polynomials per calendar time
#'
#' @description Performs linear regression taking into account all trial data until the arm under study leaves the trial and adjusting for time using discontinuous piecewise polynomials in each calendar time interval
#'
...
piecewise_cal_cont <- function(data, arm, alpha=0.025, unit_size=25, ncc=TRUE, poly_degree=3, ...){
