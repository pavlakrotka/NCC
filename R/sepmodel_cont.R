...
#'
#' @param data Data frame trial data, e.g. result from the `datasim_cont()` function. Must contain columns named 'treatment', 'response' and 'period'.
...
sepmodel_cont <- function(data, arm, alpha=0.025, check=TRUE, ...){
