...
#'
#' @description Performs separate analysis (only taking into account concurrent controls) using a linear model and adjusting for periods
#'
...
sepmodel_adj_cont <- function(data, arm, alpha=0.025, ...){
