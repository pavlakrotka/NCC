...
# new timemachine results - buckets

results_ii_pow_TM_buckets <- read_csv("results/results_ii_pow_TM_buckets.csv") %>%
  mutate(model="timemachine_buckets")
results_ii_alpha_TM_buckets <- read_csv("results/results_ii_alpha_TM_buckets.csv") %>%
  mutate(model="timemachine_buckets")
results_iii_pow_TM_buckets <- read_csv("results/results_iii_pow_TM_buckets.csv") %>%
  mutate(model="timemachine_buckets")
results_iii_alpha_TM_buckets <- read_csv("results/results_iii_alpha_TM_buckets.csv") %>%
  mutate(model="timemachine_buckets")

results_ii_pow <- rbind(results_ii_pow, results_ii_pow_TM_buckets)
results_ii_alpha <- rbind(results_ii_alpha, results_ii_alpha_TM_buckets)
results_iii_pow <- rbind(results_iii_pow, results_iii_pow_TM_buckets)
results_iii_alpha <- rbind(results_iii_alpha, results_iii_alpha_TM_buckets)
```
...
ggplot(results_ii_alpha) +
  ...
  scale_color_discrete(labels = c("Regression model", "MAP Prior", "Pooled analysis", "Separate analysis", "Timemachine", "Timemachine with buckets")) +
