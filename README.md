NCC: R package for comparing treatment arms against control in platform
...
<img src="./figures/trial_general_1.PNG" alt="Figure 1: Scheme of the platform trial over time according to the number of patients recruited to control." width="70%" />

<p class="caption">

Figure 1: Scheme of the platform trial over time according to the number
of patients recruited to control.
