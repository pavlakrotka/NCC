...
- `sw_trend()` is the stepwise time trend function, used generate the trend for each patient
...
We divide the duration of the trial into $S$ periods, where the periods are the time intervals bounded by times at a treatment arm either enters or leaves the platform.

Figure 1 illustrates the considered trial design with $K$ treatment arms and $S$ periods.

```{r, echo=FALSE, fig.cap="Figure 1: Scheme of the platform trial over time according to the number of patients recruited to control."}
