...
-   `fixmodel_bin()` performs analysis using a regression model for binary data
-   `fixmodel_cont()` performs analysis using a regression model for continuous data
-   `mixmodel_cont()` performs analysis using a mixed model for continuous data
