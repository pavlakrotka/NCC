...
```{r, echo=FALSE, fig.cap="Scheme of the platform trial over time according to the number of patients recruited to control."}
include_graphics("./figures/trial_general_2.PNG")
```
